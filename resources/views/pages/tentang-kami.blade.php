...
@section('content')
<!-- Hero Section -->
<section class="relative py-20 bg-gradient-to-r from-gray-900 to-gray-800 text-white overflow-hidden">
    <div class="absolute inset-0 bg-black opacity-50"></div>
    <img src="https://images.unsplash.com/photo-1519681393784-e1f7bb1243f3?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY3J8MHx8Y3VsdHVyYWwlMjBzb2NpZXR5fGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=1080" 
         alt="Tim Sewa Konser" 
    ...
    <div class="relative container mx-auto px-4 sm:px-6 text-center">
        <h1 class="text-4xl md:text-6xl font-bold mb-6 loading">
            Tentang <span class="text-yellow-500">Kami</span>
        </h1>
        <p class="text-xl md:text-2xl max-w-3xl mx-auto text-gray-200 loading">
    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-16 loading">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Cerita Kami</h2>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="text-center lg:text-left loading">
                    <div class="bg-yellow-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto lg:mx-0 mb-6">
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Lightstick Service -->
            <div class="text-center p-8 rounded-xl hover:shadow-lg transition hover-lift loading">
                <div class="bg-gradient-to-br from-yellow-400 to-yellow-500 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-4">Sewa Lightstick</h3>
            ...
            <!-- Powerbank Service -->
            <div class="text-center p-8 rounded-xl hover:shadow-lg transition hover-lift loading">
                <div class="bg-gradient-to-br from-blue-400 to-blue-500 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-4">Sewa Powerbank</h3>
                <p class="text-gray-600 mb-6">
            ...
            <!-- Handphone Service -->
            <div class="text-center p-8 rounded-xl hover:shadow-lg transition hover-lift loading">
                <div class="bg-gradient-to-br from-purple-400 to-purple-500 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-4">Sewa Handphone</h3>
                <p class="text-gray-600 mb-6">
...
<section class="py-20 bg-gray-900 text-white">
    <div class="container mx-auto px-4 sm:px-6">
        <div class="text-center mb-16 loading">
            ...
            <p class="text-xl text-gray-300">Kepercayaan Anda adalah kebanggaan kami</p>
        </div>

        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div class="loading">
                <div class="text-4xl md:text-5xl font-bold text-yellow-500 mb-2">5+</div>
                <div class="text-gray-300 font-medium">Tahun Pengalaman</div>
            </div>
            <div class="loading">
                <div class="text-4xl md:text-5xl font-bold text-yellow-500 mb-2">500+</div>
                <div class="text-gray-300 font-medium">Konser Dilayani</div>
            </div>
            <div class="loading">
                <div class="text-4xl md:text-5xl font-bold text-yellow-500 mb-2">1000+</div>
                <div class="text-gray-300 font-medium">Pelanggan Puas</div>
            </div>
            <div class="loading">
                <div class="text-4xl md:text-5xl font-bold text-yellow-500 mb-2">100+</div>
                <div class="text-gray-300 font-medium">Produk Tersedia</div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg text-center hover-lift loading">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Pelayanan Prima</h3>
                <p class="text-gray-600">
