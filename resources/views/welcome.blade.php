    ...
    <section class="relative bg-gradient-to-r from-gray-900 to-gray-800 text-white">
        ...
        <div class="relative container mx-auto px-4 sm:px-6 py-20 lg:py-32">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <!-- Search Form -->
                <form action="{{ route('shop') }}" method="GET" class="max-w-2xl mx-auto mb-8 loading">
                    <div class="flex gap-2">
                        <input type="text" 
                            name="search" 
                            placeholder="Cari lightstick, powerbank, handphone..." 
                            class="flex-1 px-6 py-4 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                            value="{{ request('search') }}">
                        <button type="submit" 
                                class="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold px-8 py-4 rounded-lg transition hover-lift">
