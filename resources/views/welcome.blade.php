...
<section class="relative text-white">
    <section class="relative bg-gradient-to-r from-[#194569] to-[#5F84A2] text-white">
        <img src="{{ asset('storage/img/fotow.jpg') }}" 
            alt="Konser Background" 
            class="absolute inset-0 w-full h-full object-cover"
            onerror="this.style.display='none'">

        <!-- Overlay semburat abu tipis -->
        <div class="absolute inset-0 bg-gray-700/30 backdrop-brightness-90"></div>
        <div class="relative container mx-auto px-4 sm:px-6 py-20 lg:py-32">
            <div class="max-w-4xl mx-auto text-center">
                ...
                Sewa Peralatan Konser Terpercaya
            </h1>

                <p class="text-xl md:text-2xl text-gray-100 mb-8 loading">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center loading">
                    <a href="{{ route('shop') }}" 
                    class="bg-[#B1C9EF] hover:bg-[#91AEC4] text-gray-900 font-bold px-8 py-4 rounded-lg text-lg transition hover:-translate-y-1">
                        Lihat Semua Produk
                    </a>
...
<!-- Stats Section -->
<section class="py-16 bg-[#395886] text-white">
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Lightstick -->
            <div class="group rounded-xl p-8 transition hover-lift loading" style="background-color: #B1C9EF;">
                <div class="text-center">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition" style="background-color: #395886;">
                    ...
                    <a href="/lightstick" 
                       class="inline-flex items-center font-medium" style="color: #395886;">
                        Lihat Produk 
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover-lift loading">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-medium px-2 py-1 rounded" style="background-color: #B1C9EF; color: #395886;">Popular</span>
                    </div>
                    <p class="text-gray-600 mb-4">Official lightstick BTS dengan koneksi Bluetooth dan berbagai mode pencahayaan</p>
                    <div class="flex items-center justify-between">
                        <span class="text-2xl font-bold" style="color: #395886;">Rp 75.000<span class="text-sm text-gray-500">/hari</span></span>
                        @auth
                            <a href="{{ route('lightstick.show', 3) }}" class="text-white px-4 py-2 rounded-lg font-medium transition" style="background-color: #395886;">
                                Sewa
                            </a>
                        @else
                            <a href="{{ route('signIn') }}" class="text-white px-4 py-2 rounded-lg font-medium transition" style="background-color: #395886;">
                                Sewa
                            </a>
                        @endauth
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover-lift loading">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-medium px-2 py-1 rounded" style="background-color: #B1C9EF; color: #395886;">Premium</span>
                    </div>
                    <p class="text-gray-600 mb-4">Android flagship dengan S Pen dan kamera zoom 100x untuk dokumentasi konser</p>
                    <div class="flex items-center justify-between">
                        <span class="text-2xl font-bold" style="color: #395886;">Rp 140.000<span class="text-sm text-gray-500">/hari</span></span>
                        @auth
                            <a href="{{ route('handphone.show', 2) }}" class="text-white px-4 py-2 rounded-lg font-medium transition" style="background-color: #395886;">
                                Sewa
                            </a>
                        @else
                            <a href="{{ route('signIn') }}" class="text-white px-4 py-2 rounded-lg font-medium transition" style="background-color: #395886;">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover-lift loading">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-medium px-2 py-1 rounded" style="background-color: #B1C9EF; color: #395886;">Reliable</span>
                    </div>
                    <p class="text-gray-600 mb-4">Powerbank berkualitas tinggi dengan fast charging untuk berbagai device</p>
                    <div class="flex items-center justify-between">
                        <span class="text-2xl font-bold" style="color: #395886;">Rp 25.000<span class="text-sm text-gray-500">/hari</span></span>
                        @auth
                            <a href="{{ route('powerbank.show', 6) }}" class="text-white px-4 py-2 rounded-lg font-medium transition" style="background-color: #395886;">
                                Sewa
                            </a>
                        @else
                            <a href="{{ route('signIn') }}" class="text-white px-4 py-2 rounded-lg font-medium transition" style="background-color: #395886;">
        ...
        <div class="text-center mt-12 loading">
            <a href="{{ route('shop') }}" 
               class="text-white font-bold px-8 py-4 rounded-lg transition" style="background-color: #395886;">
                Lihat Semua Produk
            </a>
        </div>
    </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6">
        <div class="text-center mb-16 loading">
            <h2 class="text-3xl md:text-4xl font-bold mb-4" style="color: #395886;">
                Mengapa Pilih Kami?
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center loading">
                <div class="bg-[#B1C9EF] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shadow-md">
                    <svg class="w-8 h-8" style="color: #395886;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                </div>
                <h3 class="text-lg font-bold mb-2" style="color: #395886;">Kualitas Terjamin</h3>
            ...
            <div class="text-center loading">
                ...
                <h3 class="text-lg font-bold mb-2" style="color: #395886;">Harga Terjangkau</h3>
            ...
            <div class="text-center loading">
                ...
                <h3 class="text-lg font-bold mb-2" style="color: #395886;">Layanan 24/7</h3>
            ...
            <div class="text-center loading">
                ...
                <h3 class="text-lg font-bold mb-2" style="color: #395886;">Proses Cepat</h3>
