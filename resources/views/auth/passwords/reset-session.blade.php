        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="text-center mb-8 loading">
                <div class="relative mb-6">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-400 w-20 h-20 rounded-full mx-auto blur-lg opacity-30"></div>
                    <!-- Icon container -->
                    <div class="relative bg-gradient-to-r from-blue-500 to-blue-500 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto shadow-lg transform hover:scale-105 transition duration-300">
                ...
                <form method="POST" action="{{ route('password.reset-session') }}" class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative group" x-data="{ showPassword: false }">
                            <input :type="showPassword ? 'text' : 'password'" 
                                   ...
                                   name="password" 
                                   required 
                                   class="w-full pl-12 pr-12 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition duration-300 bg-gray-50/50 group-hover:bg-white @error('password') border-red-400 focus:border-red-400 focus:ring-red-500/20 @enderror" 
                    ...
                    <div class="relative">
                        ...
                        <div class="relative group" x-data="{ showConfirmPassword: false }">
                            <input :type="showConfirmPassword ? 'text' : 'password'" 
                                   ...
                                   required 
                                   class="w-full pl-12 pr-12 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition duration-300 bg-gray-50/50 group-hover:bg-white" 
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-sm font-semibold text-blue-800 mb-2">Tips Password Aman:</h4>
                    ...
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-600 hover:to-blue-600 text-white font-bold py-4 px-6 rounded-xl transition duration-300 transform hover:scale-[1.02] hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-500/50">
                    ...
                    <div class="text-center">
                        <a href="{{ route('password.request') }}" 
                           class="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-700 hover:underline transition duration-300 mr-4">
            ...
            <!-- Security Notice -->
            <div class="mt-8 bg-gradient-to-r from-blue-50 to-blue-50 border-2 border-blue-200/50 rounded-2xl p-6 loading">
                <div class="flex items-start">
